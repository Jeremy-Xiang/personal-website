...
export const PORTFOLIO_RETURNS = [
...
export const PORTFOLIO_STACK = ['python', 'fastapi', 'scikit-learn', 'react', 'yfinance', 'pandas', 'finbert', 'recharts', 'render', 'vercel']

export const PORTFOLIO_JOURNAL = [
